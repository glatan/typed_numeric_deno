...
Deno.test("Uint128.prototype", () => {
  ...
  assertEquals(
    ...
    new Uint8Vector(16).fill(0xFF),
  );
  assertEquals(new Uint128(Uint128.min()).toBeBytes(), new Uint8Vector(16));
  // toLeBytes()
  assertEquals(
  ...
  assertEquals(new Uint128(Uint128.min()).toLeBytes(), new Uint8Vector(16));
});
